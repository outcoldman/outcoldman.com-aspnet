namespace OutcoldSolutions.Web.Blog.Models.Repositories
{
    ...
    public class NotificationRepository : IDisposable
    {
        ...
        public LocalDatabaseEntities DataContext { get { return this._dataContext; } }
        ...
        public IList<NotificationModel> GetNotifications()
        {
            return (from n in this.DataContext.Notifications
                    ...
                    join s in this.DataContext.CommentSubscriptions on new { c.PostID, email = n.Email.ToLower() } equals new { s.PostID, email = s.Email.ToLower() } into sd
