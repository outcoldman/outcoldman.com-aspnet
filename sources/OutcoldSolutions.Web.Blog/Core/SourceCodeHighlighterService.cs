		...
		private readonly StyleConfig _config = new StyleConfig()
		                                       	{
													...
													WrapperStyle = "border: silver 1px solid; text-align: left; padding: 4px 4px 4px 4px; line-height: 10pt; background-color: #f4f4f4; margin: 20px 0px 10px; width: 97.5%; font-family: Tahoma, Verdana, courier, monospace; direction: ltr; color: black; overflow: auto; cursor: text; font-size:9pt;"
		                                       	};

		private readonly SortedDictionary<string, SupportedFormatType> _supportedFormats = new SortedDictionary<string, SupportedFormatType>()
		                                         	{
