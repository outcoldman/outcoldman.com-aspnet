                ...
                if (input[i] == '[')
                {
                    ...
                    if (string.Compare(input.Substring(i - 5, 5), "[code", true) == 0)
                    {
                        ...
                        if (type != null)
                        {
                            ...
                            while (input[i] != '[' || char.ToLower(input[i + 1]) != '/'
                                   || char.ToLower(input[i + 2]) != 'c' || char.ToLower(input[i + 3]) != 'o'
                                   || char.ToLower(input[i + 4]) != 'd' || char.ToLower(input[i + 5]) != 'e'
                            ...
                            if (code != null)
                            {
                                i += 6;
                                result.Append(
                                    service.HighlightCode(code.ToString().Trim(' ', '\r', '\n'), type.ToString().Trim()));
                            }
                        }
                    }
