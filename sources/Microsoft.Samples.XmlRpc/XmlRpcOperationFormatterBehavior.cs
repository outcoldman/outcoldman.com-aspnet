...
namespace Microsoft.Samples.XmlRpc
{
	...
	{
		private readonly DataContractSerializerOperationBehavior _dcs;
		private readonly XmlSerializerOperationBehavior _xcs;

		public XmlRpcOperationFormatterBehavior(DataContractSerializerOperationBehavior dcs,
		                                        XmlSerializerOperationBehavior xcs)
		{
			_dcs = dcs;
			_xcs = xcs;
		}
